...
Use parameters instead of SQL interpolation. Supported types: `nvarchar`, `int`, `bigint`, `decimal`, `decimal(p,s)`, `bit`, `date`, `datetime`, `datetime2`, `datetimeoffset`, `uniqueidentifier`. Values are culture-invariant; date/time use ISO 8601 (for example `--param asOf:datetime2=2026-07-29T12:00:00` and `--param amount:decimal(19,4)=1234.5600`).
